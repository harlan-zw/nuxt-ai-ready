...
- 🧩 **[WebMCP](https://nuxtseo.com/ai-ready/guides/webmcp)**: Register tools with in-browser AI agents via `document.modelContext`, with a `useWebMcpTool()` composable for your own
