...
The `llms.txt` file provides a concise overview of your site for AI systems. It's generated on build based
on the inferred metadata and structure of your pages.

The structure schema looks like the below, for a live example see [nuxtseo.com/llms.txt](https://nuxtseo.com/llms.txt):
