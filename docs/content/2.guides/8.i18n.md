...
| Surface | Behavior |
|---|---|
| **`llms.txt`** | Adds an `## Available Languages on Website` section listing every locale, page count, and locale-root link. Default-locale pages stay inlined; other locales appear as references. (Anthropic precedent.) |
