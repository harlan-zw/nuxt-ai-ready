...
Nuxt AI Ready supports [Model Context Protocol (MCP)](https://modelcontextprotocol.io/) when
the [`@nuxtjs/mcp-toolkit`](https://github.com/nuxt-modules/mcp-toolkit) is installed.

Your site exposes MCP tools and resources to AI agents like [Claude](https://claude.ai/) based on your indexed content.
...
::tabs
::tab{label="Production"}
Page-level metadata in TOON format. Each page has `chunkIds[]` to join with pages-chunks resource.
