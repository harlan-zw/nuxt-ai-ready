...
Nuxt AI Ready v1 is a pre-release quality audit focused on **API consistency**, **security**, and **reliability**.
...
See the full [migration steps](#breaking-changes) below, or paste the [agent migration prompt](#agent-migration-prompt) into your AI coding tool to upgrade automatically.
...
// nuxt.config.ts
aiReady: {
  mdreamOptions: { minimal: true, clean: true }
}
```
