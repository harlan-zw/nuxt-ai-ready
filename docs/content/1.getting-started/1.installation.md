...
>
> If you only prerender your site, set `aiReady.database: false`{lang="ts"} and skip the driver.
...
4. **[IndexNow](/docs/ai-ready/guides/indexnow)** - Instant search engine notifications
5. **[Runtime Indexing](/docs/ai-ready/guides/runtime-indexing)** - Database, TTL, and search configuration
6. **[Cloudflare Deployment](/docs/ai-ready/guides/cloudflare)** - Deploy with D1 database
