...
[Source policy](SOURCES.md). Checked 2026-09-15 against Nuxt AI Ready 2.3.3 source.

Page briefs carry claim tables, exact sources, qualifications, and check dates.
This index links those tables instead of duplicating their conclusions.
Use Documented for inspected primary documentation and Observed for saved implementation or runtime evidence.
Mark missing external evidence Unresolved. Preserve withdrawn claims with their reason.
